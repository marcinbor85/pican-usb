...
#pragma config PWRTS = PWRT_OFF // Power-up timer selection bits (PWRT set at 64ms)
...
// CONFIG3L
#pragma config WDTCPS = WDTCPS_10// WDT Period selection bits (Divider ratio 1:65536; software control of WDTPS)
